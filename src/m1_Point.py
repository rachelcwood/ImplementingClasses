...
class Point(object):
    ...
    def get_number_of_moves_made(self):
        return self.coutmoves

    def get_distance_from(self, pnew):
        self.distx = self.x - pnew.x
        self.disty = self.y - pnew.y
    ...
    def closer_to(self, p2, p3):
        ...
        dist1 = p1.get_distance_from(p2)
        dist2 = p1.get_distance_from(p3)
        if dist2 < dist1:
            return p3
        else:
            return p2
